...
- **Draft** — [Develop Mini BRS](develop-mini-brs/SKILL.md): guide a lightweight Vision/Scope, Capability Map, and capability-level Business Rules workflow through confirmed, traceable checkpoints.
